...
namespace AspNetPerformance
{
    ...
    public class ConfigInfo
    {
        ...
        /// </summary>
        public const String CATEGORY_NAME_KEY = "AspNetPerformance.PerformanceCounterCategory";
        ...
        private static ConfigInfo InitializeConfigInfo()
        {
            ...
            String categoryName = ConfigurationManager.AppSettings[CATEGORY_NAME_KEY];
